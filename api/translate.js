...
【絶対ルール】
1. "full_ipa" と "full_katakana" は、必ず「タイ語」の発音を記述してください。
2. IPAは音節間をハイフン'-'で区切り、全音節に声調記号(à, á, â, ǎ)を付けてください。
3. カタカナ記号：平声:→, 高声:↑, 低声:↓, 下がる:↘, 上がる:↗, 長音:〜
スキーマ:
{
  "full_translation": "翻訳後の文全体",
  "full_ipa": "タイ語側の音節区切りIPA",
  "full_katakana": "タイ語側の声調記号付カタカナ",
